...
const overtakeStartedLogRegExp = /(\d{4})\.(\d{2})\.(\d{2})-(\d{2})\.(\d{2})\.(\d{2}): \[LogBaseBuilding\] \[Flag\] Overtake started\. User: (([\s|\S]*) \((\d*), (\d{17})\)|N\/A) Location: X=([\s|\S]*) Y=([\s|\S]*) Z=([\s|\S]*)\. Owner: ((\d{17})\((\d*), ([\s|\S]*)\)|N\/A|-1\(\)|0\(World\))\. FlagId: ([\s|\S]*)\. Location: X=([\s|\S]*) Y=([\s|\S]*) Z=([\s|\S]*)/;
const overtakeCanceledLogRegExp = /(\d{4})\.(\d{2})\.(\d{2})-(\d{2})\.(\d{2})\.(\d{2}): \[LogBaseBuilding\] \[Flag\] Overtake canceled\. User: (([\s|\S]*) \((\d*), (\d{17})\)|N\/A)\. Owner: ((\d{17})\((\d*), ([\s|\S]*)\)|N\/A|-1\(\)|0\(World\))\. FlagId: ([\s|\S]*)\. Location: X=([\s|\S]*) Y=([\s|\S]*) Z=([\s|\S]*)/;
const overtakeAbandonedLogRegExp = /(\d{4})\.(\d{2})\.(\d{2})-(\d{2})\.(\d{2})\.(\d{2}): \[LogBaseBuilding\] \[Flag\] Abandoned on overtake\. Overtaker: ((\d{17})\((\d*), ([\s|\S]*)\)|N\/A|-1\(\)|0\(World\))\. Old owner: ((\d{17})\((\d*), ([\s|\S]*)\)|N\/A|-1\(\)|0\(World\))\. FlagId: ([\s|\S]*)\. Location: X=([\s|\S]*) Y=([\s|\S]*) Z=([\s|\S]*)/;
const overtakeOvertakenLogRegExp = /(\d{4})\.(\d{2})\.(\d{2})-(\d{2})\.(\d{2})\.(\d{2}): \[LogBaseBuilding\] \[Flag\] (Overtaken|Overtaken \([\s|\S]*\))\. New owner: ((\d{17})\((\d*), ([\s|\S]*)\)|N\/A|-1\(\)|0\(World\))\. Old owner: ((\d{17})\((\d*), ([\s|\S]*)\)|N\/A|-1\(\)|0\(World\))\. FlagId: ([\s|\S]*)\. Location: X=([\s|\S]*) Y=([\s|\S]*) Z=([\s|\S]*)/;
