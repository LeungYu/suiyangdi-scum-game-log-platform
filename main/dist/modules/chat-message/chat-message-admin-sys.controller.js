...
exports.ChatMessageAdminSysController = void 0;
const common_1 = require("@nestjs/common");
const chat_message_admin_sys_1 = require("../../dto/chat-message-admin-sys");
...
let ChatMessageAdminSysController = class ChatMessageAdminSysController {
    ...
    list(page, query, res) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                ...
                const resGetChatMessageListLike = yield this.chatMessageService.getChatMessageListLike(page, {
                    scumId: query.scumId,
    ...
    delete(query, res) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                const resDeleteChatMessage = yield this.chatMessageService.deleteChatMessage({
                    id: query.id,
                });
                return res.json((0, response_builder_1.responseBuilder)(response_builder_1.ResponseStatusCode.OK, resDeleteChatMessage, ''));
            }
            catch (e) {
                (0, morgan_log_1.logBussiness)(e);
    ...
    clean(userInfo, res) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                const resCleanChatMessage = yield this.chatMessageService.clearChatMessage();
...
__decorate([
    ...
    __metadata("design:paramtypes", [page_1.Page,
        chat_message_admin_sys_1.ListChatMessageSysDto, Object]),
    __metadata("design:returntype", Promise)
], ChatMessageAdminSysController.prototype, "list", null);
__decorate([
    (0, common_1.Get)('/info'),
    __param(0, (0, common_1.Query)()),
    __param(1, (0, common_1.Res)()),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [chat_message_admin_sys_1.ChatMessageInfoSysDto, Object]),
    __metadata("design:returntype", Promise)
], ChatMessageAdminSysController.prototype, "info", null);
__decorate([
    ...
    __param(1, (0, common_1.Res)()),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [chat_message_admin_sys_1.DeleteChatMessageSysDto, Object]),
    __metadata("design:returntype", Promise)
], ChatMessageAdminSysController.prototype, "delete", null);
__decorate([
    ...
    __metadata("design:returntype", Promise)
], ChatMessageAdminSysController.prototype, "clean", null);
