...
let ChestOwnershipRecordService = class ChestOwnershipRecordService {
    ...
    saveChestOwnershipRecord(scumId, steamId, sessionId, type, createdLocations, createdArea, createdTimeStamp, targetName, otherConfig) {
        return __awaiter(this, void 0, void 0, function* () {
            return yield this.chestOwnershipRecordRepository.save(new chest_ownership_record_entity_1.ChestOwnershipRecord(scumId, steamId, sessionId, type, createdLocations, createdArea, createdTimeStamp, targetName, otherConfig));
        });
    }
    ...
    getChestOwnershipRecordListLike(page, data) {
        return __awaiter(this, void 0, void 0, function* () {
            let res = yield this.chestOwnershipRecordRepository.createQueryBuilder('chestOwnershipRecord');
            res = res.leftJoinAndMapOne('chestOwnershipRecord.chestOwnershipRecordFromUser', user_entity_1.User, "chestOwnershipRecordFromUser", "chestOwnershipRecord.fromSteamId = chestOwnershipRecordFromUser.steamId");
            res = res.leftJoinAndMapOne('chestOwnershipRecord.chestOwnershipRecordToUser', user_entity_1.User, "chestOwnershipRecordToUser", "chestOwnershipRecord.toSteamId = chestOwnershipRecordToUser.steamId");
            if (data.fromScumId !== undefined) {
