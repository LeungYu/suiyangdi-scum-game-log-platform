...
ChestOwnershipRecordModule = __decorate([
    (0, common_1.Module)({
        imports: [typeorm_1.TypeOrmModule.forFeature([chest_ownership_record_entity_1.ChestOwnershipRecord])],
        providers: [chest_ownership_record_service_1.ChestOwnershipRecordService],
