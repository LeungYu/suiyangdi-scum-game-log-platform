        ...
        return new Promise((resolve) => __awaiter(this, void 0, void 0, function* () {
            ...
            try {
                ...
                for (let targetFileName of targetFileNames) {
                    ...
                    const loginLogs = yield ServerSchedulesPrivateServerLogQueueService_1.privateLogsInstance.getLoginLog(GameAreaRanges, targetFileName);
        ...
        return new Promise((resolve) => __awaiter(this, void 0, void 0, function* () {
            ...
            try {
                ...
                for (let targetFileName of targetFileNames) {
                    let resGameAreaRanges = yield this.serverConfigService.getServerConfig({ name: 'GameAreaRanges' });
                    let GameAreaRanges = JSON.parse(resGameAreaRanges.value).value;
                    const killLogs = yield ServerSchedulesPrivateServerLogQueueService_1.privateLogsInstance.getKillLog(GameAreaRanges, targetFileName);
        ...
        return new Promise((resolve) => __awaiter(this, void 0, void 0, function* () {
            ...
            try {
                ...
                for (let targetFileName of targetFileNames) {
                    let resGameAreaRanges = yield this.serverConfigService.getServerConfig({ name: 'GameAreaRanges' });
                    let GameAreaRanges = JSON.parse(resGameAreaRanges.value).value;
                    const adminLogs = yield ServerSchedulesPrivateServerLogQueueService_1.privateLogsInstance.getAdminLog(GameAreaRanges, targetFileName);
    ...
    proccessChatLogs(chatLogFileNames) {
        return new Promise((resolve) => __awaiter(this, void 0, void 0, function* () {
            ...
            try {
                ...
                for (let targetFileName of targetFileNames) {
                    const chatLogs = yield ServerSchedulesPrivateServerLogQueueService_1.privateLogsInstance.getChatLog(targetFileName);
        ...
        return new Promise((resolve) => __awaiter(this, void 0, void 0, function* () {
            ...
            try {
                ...
                for (let targetFileName of targetFileNames) {
                    let resGameAreaRanges = yield this.serverConfigService.getServerConfig({ name: 'GameAreaRanges' });
                    let GameAreaRanges = JSON.parse(resGameAreaRanges.value).value;
                    const actionsLog = yield ServerSchedulesPrivateServerLogQueueService_1.privateLogsInstance.getActionsLog(GameAreaRanges, targetFileName);
        ...
        return new Promise((resolve) => __awaiter(this, void 0, void 0, function* () {
            ...
            try {
                ...
                for (let targetFileName of targetFileNames) {
                    let resGameAreaRanges = yield this.serverConfigService.getServerConfig({ name: 'GameAreaRanges' });
                    let GameAreaRanges = JSON.parse(resGameAreaRanges.value).value;
                    const violationsLog = yield ServerSchedulesPrivateServerLogQueueService_1.privateLogsInstance.getViolationsLog(GameAreaRanges, targetFileName);
        ...
        return new Promise((resolve) => __awaiter(this, void 0, void 0, function* () {
            ...
            try {
                ...
                for (let targetFileName of targetFileNames) {
                    let resGameAreaRanges = yield this.serverConfigService.getServerConfig({ name: 'GameAreaRanges' });
                    let GameAreaRanges = JSON.parse(resGameAreaRanges.value).value;
                    const economysLog = yield ServerSchedulesPrivateServerLogQueueService_1.privateLogsInstance.getEconomyLog(GameAreaRanges, targetFileName);
