...
var ServerSchedulesPrivateServerLogQueueService_1;
Object.defineProperty(exports, "__esModule", { value: true });
exports.ServerSchedulesPrivateServerLogQueueService = exports.ServerLogTaskType = void 0;
...
const private_logs_1 = require("../../common/private-logs");
...
(function (ServerLogTaskType) {
    ServerLogTaskType[ServerLogTaskType["GET_PRIVATE_SERVER_LOG"] = 0] = "GET_PRIVATE_SERVER_LOG";
})(ServerLogTaskType = exports.ServerLogTaskType || (exports.ServerLogTaskType = {}));
const FAILURE_RETRY_INTERVAL = 3000;
let ServerSchedulesPrivateServerLogQueueService = ServerSchedulesPrivateServerLogQueueService_1 = class ServerSchedulesPrivateServerLogQueueService {
    constructor(serverConfigService, userLoginService, killService, adminCommandService, chatMessageService, actionsRecordService, violationsRecordService, economyService, chestOwnershipRecordService, vehicleDestructionRecordService, unrecognizedRecordService) {
        ...
        this.add({
            timeStamp: Date.now() + '',
            taskType: ServerLogTaskType.GET_PRIVATE_SERVER_LOG
        }, {
            delay: 0,
        });
    }
    add(task, opts) {
        return __awaiter(this, void 0, void 0, function* () {
            let resPrivateLogsRollbackSingleTimeout = yield this.serverConfigService.getServerConfig({ name: 'PrivateLogsRollbackSingleTimeout' });
            const PrivateLogsRollbackSingleTimeout = JSON.parse(resPrivateLogsRollbackSingleTimeout.value).value;
            task_qull_1.SinglePrivateServerLogQueue.add(task, Object.assign(Object.assign({}, opts), { backoff: FAILURE_RETRY_INTERVAL, timeout: PrivateLogsRollbackSingleTimeout || 360000 }));
        });
    }
    serverLogQueueHandler() {
        task_qull_1.SinglePrivateServerLogQueue.on('completed', (job, result) => __awaiter(this, void 0, void 0, function* () {
            if (result.proccess) {
                (0, morgan_log_1.logPrivateProccessLog)(true, `[gportal][timeStamp: ${job.data.timeStamp}, taskType: ${job.data.taskType} ]success`);
            }
            else {
                (0, morgan_log_1.logPrivateProccessLog)(false, `[gportal][timeStamp: ${job.data.timeStamp}, taskType: ${job.data.taskType} ]skip`);
            }
            let PrivateLogsRollbackInterval = yield this.serverConfigService.getServerConfig({ name: 'PrivateLogsRollbackInterval' });
            PrivateLogsRollbackInterval = JSON.parse(PrivateLogsRollbackInterval.value).value;
            yield this.add({
                timeStamp: Date.now() + '',
                taskType: ServerLogTaskType.GET_PRIVATE_SERVER_LOG,
            }, {
                delay: result.noPrivate === true ? 1000 * 60 : PrivateLogsRollbackInterval,
            });
            job.remove();
        }));
        task_qull_1.SinglePrivateServerLogQueue.on('failed', (job, err) => __awaiter(this, void 0, void 0, function* () {
            (0, morgan_log_1.logPrivateProccessLog)(true, `[gportal][timeStamp: ${job.data.timeStamp}, taskType: ${job.data.taskType} ]error, resaon:${err}`);
            (0, morgan_log_1.logPrivateProccessLog)(true, `[gportal][timeStamp: ${job.data.timeStamp}, taskType: ${job.data.taskType} ]retry`);
            yield this.add({
                timeStamp: Date.now() + '',
                taskType: ServerLogTaskType.GET_PRIVATE_SERVER_LOG,
            }, {
        ...
        task_qull_1.SinglePrivateServerLogQueue.process((job, done) => __awaiter(this, void 0, void 0, function* () {
            (0, morgan_log_1.logPrivateProccessLog)(false, `catch private task: ${job.data.taskType}`);
            const { taskType } = job.data;
            let res = undefined;
            switch (taskType) {
                case ServerLogTaskType.GET_PRIVATE_SERVER_LOG:
                    res = yield this.getPrivateServerLog();
                    break;
                default:
                    break;
            }
    ...
    getPrivateServerLog(initialize) {
        return __awaiter(this, void 0, void 0, function* () {
            let resGetEnablePrivateLogsRollback = yield this.serverConfigService.getServerConfig({ name: 'EnablePrivateLogsRollback' });
            const EnablePrivateLogsRollback = JSON.parse(resGetEnablePrivateLogsRollback.value).value;
            ...
            if (EnablePrivateLogsRollback === false || GameServerType !== 'PRIVATE') {
                return {
                    proccess: false,
                    noPrivate: GameServerType !== 'PRIVATE'
                };
            }
            else {
                if (ServerSchedulesPrivateServerLogQueueService_1.privateLogsInstance === undefined || ServerSchedulesPrivateServerLogQueueService_1.updateFlag === true) {
                    (0, morgan_log_1.logPrivateProccessLog)(true, '--------------------interlize--------------------');
    ...
    getServerLogsSchedule() {
        var _a, _b, _c;
        return __awaiter(this, void 0, void 0, function* () {
            (0, morgan_log_1.logPrivateProccessLog)(true, `call: ${new Date().toISOString()}`);
            try {
                ...
                const resGetLogsFileNamesJson = yield ServerSchedulesPrivateServerLogQueueService_1.privateLogsInstance.getLogsFileNamesJSon();
                ...
                const resUpdatePrivateServerLogAsyncRecord = this.serverConfigService.updateServerConfig({
                    name: 'PrivateServerLogAsyncRecord',
                ...
                (0, morgan_log_1.logPrivateProccessLog)(true, '[retry] get log / server status', e.toString());
        ...
        return new Promise((resolve) => __awaiter(this, void 0, void 0, function* () {
            ...
            try {
                ...
                for (let targetFileName of targetFileNames) {
                    ...
                    let loginLogs = yield ServerSchedulesPrivateServerLogQueueService_1.privateLogsInstance.getLoginLog(GameAreaRanges, targetFileName);
        ...
        return new Promise((resolve) => __awaiter(this, void 0, void 0, function* () {
            ...
            try {
                ...
                for (let targetFileName of targetFileNames) {
                    let resGameAreaRanges = yield this.serverConfigService.getServerConfig({ name: 'GameAreaRanges' });
                    let GameAreaRanges = JSON.parse(resGameAreaRanges.value).value;
                    let killLogs = yield ServerSchedulesPrivateServerLogQueueService_1.privateLogsInstance.getKillLog(GameAreaRanges, targetFileName);
        ...
        return new Promise((resolve) => __awaiter(this, void 0, void 0, function* () {
            ...
            try {
                ...
                for (let targetFileName of targetFileNames) {
                    let resGameAreaRanges = yield this.serverConfigService.getServerConfig({ name: 'GameAreaRanges' });
                    let GameAreaRanges = JSON.parse(resGameAreaRanges.value).value;
                    let adminLogs = yield ServerSchedulesPrivateServerLogQueueService_1.privateLogsInstance.getAdminLog(GameAreaRanges, targetFileName);
    ...
    proccessChatLogs(chatLogFileNames) {
        return new Promise((resolve) => __awaiter(this, void 0, void 0, function* () {
            ...
            try {
                ...
                for (let targetFileName of targetFileNames) {
                    let chatLogs = yield ServerSchedulesPrivateServerLogQueueService_1.privateLogsInstance.getChatLog(targetFileName);
        ...
        return new Promise((resolve) => __awaiter(this, void 0, void 0, function* () {
            ...
            try {
                ...
                for (let targetFileName of targetFileNames) {
                    let resGameAreaRanges = yield this.serverConfigService.getServerConfig({ name: 'GameAreaRanges' });
                    let GameAreaRanges = JSON.parse(resGameAreaRanges.value).value;
                    let actionsLog = yield ServerSchedulesPrivateServerLogQueueService_1.privateLogsInstance.getActionsLog(GameAreaRanges, targetFileName);
        ...
        return new Promise((resolve) => __awaiter(this, void 0, void 0, function* () {
            ...
            try {
                ...
                for (let targetFileName of targetFileNames) {
                    let resGameAreaRanges = yield this.serverConfigService.getServerConfig({ name: 'GameAreaRanges' });
                    let GameAreaRanges = JSON.parse(resGameAreaRanges.value).value;
                    let violationsLog = yield ServerSchedulesPrivateServerLogQueueService_1.privateLogsInstance.getViolationsLog(GameAreaRanges, targetFileName);
        ...
        return new Promise((resolve) => __awaiter(this, void 0, void 0, function* () {
            ...
            try {
                ...
                for (let targetFileName of targetFileNames) {
                    let resGameAreaRanges = yield this.serverConfigService.getServerConfig({ name: 'GameAreaRanges' });
                    let GameAreaRanges = JSON.parse(resGameAreaRanges.value).value;
                    let economysLog = yield ServerSchedulesPrivateServerLogQueueService_1.privateLogsInstance.getEconomyLog(GameAreaRanges, targetFileName);
    ...
    proccessChestOwnershipLogs(chestOwnershipLogFileNames) {
        return new Promise((resolve) => __awaiter(this, void 0, void 0, function* () {
            ...
            try {
                ...
                let GameAreaRanges = JSON.parse(resGameAreaRanges.value).value;
                for (let targetFileName of targetFileNames) {
                    let chestOwnershipLogs = yield ServerSchedulesPrivateServerLogQueueService_1.privateLogsInstance.getChestOwnershipLog(GameAreaRanges, targetFileName);
    ...
    proccessVehicleDestructionLogs(vehicleDestructionLogFileNames) {
        return new Promise((resolve) => __awaiter(this, void 0, void 0, function* () {
            ...
            try {
                ...
                let GameAreaRanges = JSON.parse(resGameAreaRanges.value).value;
                for (let targetFileName of targetFileNames) {
                    let vehicleDestructionLogs = yield ServerSchedulesPrivateServerLogQueueService_1.privateLogsInstance.getVehicleDestructionLog(GameAreaRanges, targetFileName);
        ...
        return new Promise((resolveAll, rejectServerStatus) => __awaiter(this, void 0, void 0, function* () {
            try {
                ...
                if (BattleMetricServerId === null || BattleMetricServerId === void 0 ? void 0 : BattleMetricServerId.length) {
                    ...
                    const resGetServerStatus = yield ServerSchedulesPrivateServerLogQueueService_1.privateLogsInstance.getServerStatus(BattleMetricServerId);
...
ServerSchedulesPrivateServerLogQueueService.updateFlag = false;
ServerSchedulesPrivateServerLogQueueService = ServerSchedulesPrivateServerLogQueueService_1 = __decorate([
...
], ServerSchedulesPrivateServerLogQueueService);
exports.ServerSchedulesPrivateServerLogQueueService = ServerSchedulesPrivateServerLogQueueService;
//# sourceMappingURL=server-schedules.private-server-log.queue.service.js.map